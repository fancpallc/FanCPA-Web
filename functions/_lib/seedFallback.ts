...
export const FALLBACK_SECTIONS: FallbackSection[] = [
    ...
    items: [
      {
        ...
        image_url: 'https://images.unsplash.com/photo-1560520653-9e0e4c89eb11?w=400&auto=format&fit=crop', image_alt: 'A modern office space',
        author: 'FanCPA Team',
        sort_order: 0,
        is_visible: 1,
      },
  ...
  },
  {
    ...
    items: [{ id: 'item_cta_1', section_id: 'sec_cta', title: null, body: null, link_url: '/#calendar', link_text: 'Schedule a meeting', sort_order: 0, is_visible: 1 }],
  },
  {
    id: 'sec_gallery',
    page_id: 'page_home',
